...
<div class="ochuafb">
    <div class="feedback-section">
        ...
        <div class="khungfb2">
            <img src="../assets/img/fb3.webp" alt="" style="width: 100%; padding: 5px;">
            <div class="boxbefb">
            <img src="../assets/img/fb4.jpg" alt="" style="width: 50%; padding: 5px;">
            <img src="../assets/img/fb5.webp" alt="" style="width: 50%;padding: 5px;">
        </div>
        </div>
    </div>
</div>
